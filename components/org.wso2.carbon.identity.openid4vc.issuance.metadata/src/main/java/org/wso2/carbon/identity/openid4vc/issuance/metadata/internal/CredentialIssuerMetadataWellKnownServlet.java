...
@Component(
        ...
        immediate = true,
        property = {
                "osgi.http.whiteboard.servlet.pattern=/.well-known/openid-credential-issuer/*",
                "osgi.http.whiteboard.servlet.name=OID4VCICredentialIssuerMetadata",
                "osgi.http.whiteboard.servlet.asyncSupported=true"
        }
)
public class CredentialIssuerMetadataWellKnownServlet extends AbstractMetadataWellKnownServlet {

    private static final long serialVersionUID = -8604763241216465258L;
    ...
    protected CredentialIssuerMetadataResponse resolveMetadata(CredentialIssuerMetadataProcessor processor,
        ...
        return processor.getMetadataResponse(tenantDomain);
    }
